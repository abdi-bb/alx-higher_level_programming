...
class TestRectangle_instantiation(unittest.TestCase):
    '''Testing for constructor method'''
    ...
    def test_private_width(self):
        with self.assertRaises(AttributeError):
            print(Rectangle(4, 2, 0, 0, 89).__width)

    def test_private_height(self):
        with self.assertRaises(AttributeError):
            print(Rectangle(4, 2, 0, 0, 89).__height)

    def test_private_x(self):
        with self.assertRaises(AttributeError):
            print(Rectangle(4, 2, 0, 0, 89).__x)

    def test_private_y(self):
        with self.assertRaises(AttributeError):
            print(Rectangle(4, 2, 0, 0, 89).__y)

    def test_get_width(self):
        self.assertEqual(4, Rectangle(4, 2, 0, 0, 89).width)

    def test_set_width(self):
        r = Rectangle(3, 2, 0, 0, 89)
        r.width = 5
        self.assertEqual(5, r.width)

    def test_get_height(self):
        self.assertEqual(2, Rectangle(4, 2, 0, 0, 89).height)

    def test_set_height(self):
        r = Rectangle(4, 1, 0, 0, 89)
        r.height = 2
        self.assertEqual(2, r.height)

    def test_get_x(self):
        self.assertEqual(0, Rectangle(4, 2, 0, 0, 89).x)

    def test_set_x(self):
        r = Rectangle(4, 2, 1, 0, 89)
        r.x = 0
        self.assertEqual(0, r.x)

    def test_get_y(self):
        self.assertEqual(0, Rectangle(4, 2, 0, 0, 89).y)

    def test_set_y(self):
        r = Rectangle(4, 2, 0, 1, 89)
        r.y = 0
        self.assertEqual(0, r.y)


class TestRectangle_width(unittest.TestCase):
    '''Testing for instantiation of width'''
...
class TestRectangle_x(unittest.TestCase):
    '''Testing for instantiation of x'''
...
class TestRectangle_y(unittest.TestCase):
    '''Testing for instantiation of y'''
...
class TestRectangle_arg_order(unittest.TestCase):
    '''Testing for attribute order'''
...
class TestRectangle_update_args(unittest.TestCase):
    '''Testing update args of Class Rectangle'''
...
class TestRectangle_update_kwargs(unittest.TestCase):
    '''Testing for update kwargs of Class Rectangle'''
