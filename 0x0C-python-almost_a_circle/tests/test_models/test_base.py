...
class TestBase_instantiation(unittest.TestCase):
    ...
    def test_dict_id(self):
        self.assertEqual({'abdi': 4, 'b': 1}, Base({'abdi': 4, 'b': 1}).id)

    def test_float_id(self):
        self.assertEqual(89.1, Base(89.1).id)
    ...
    def test_bytes_id(self):
        self.assertEqual(b'abdi', Base(b'abdi').id)

    def test_bytearray_id(self):
        self.assertEqual(bytearray(b'abdi'), Base(bytearray(b'abdi')).id)

    def test_memoryview_id(self):
        self.assertEqual(memoryview(b'abdi'), Base(memoryview(b'abdi')).id)
...
class TestBase_from_json_string(unittest.TestCase):
    '''Testing for from_json_string method'''
